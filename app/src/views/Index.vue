<template>
    <div class="grid place-items-center items-center justify-center h-screen">
        <div class="grid place-items-center -translate-y-16">
            <!-- <button class="bg-orange-600 bg-opacity-90 hover:bg-orange-600 p-3 ps-5 pe-5 rounded-lg text-white"
                @click="clickSignInButton()">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                    class="bi bi-github inline-flex" viewBox="0 0 17 17">
                    <path
            ...
            <button @click="client.requestCode();">Authorize with Google</button>
        </div>
    </div>
</template>
