        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-zinc-800">
                ...
                <div
                    ...
                    <div class="flex text-xl font-semibold text-zinc-900 dark:text-white place-items-center">
                        <fai :icon="modalIcon" class="mr-3 text-2xl"/>{{ props.modal?.title }}
                    </div>
                    <!-- @vue-ignore -->
                    <button type="button"
                ...
                <!-- Modal body -->
                <div class="p-4 md:p-5 space-y-4 bg-zinc-50 dark:bg-zinc-800 text-center" v-html="props.modal?.message">
                </div>
                <!-- Footer -->
                <div
