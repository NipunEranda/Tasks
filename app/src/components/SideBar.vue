<template>
    <aside id="sideBar"
        class="fixed top-0 left-0 z-40 w-64 h-screen dark:bg-theme-primary dark:brightness-110 transition-all -translate-x-full lg:translate-x-0 duration-300 border-r-1 dark:border-theme-primary-border/30">
        <div class="w-full">
